...
class ContactController extends Controller
{
    ...
    public function store() {
        ...
        $contact->name = Crypt::encryptString('Marina Matulle');
        $contact->email = Crypt::encryptString('marinamatulle.mm@gmail.com');
        $contact->telefone = Crypt::encryptString('(42) 99999-99999');
        $contact->data_nascimento = Crypt::encryptString('2000-10-26');
        $contact->save();
    }
